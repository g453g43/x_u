...
local G = Instance.new("UIGradient", AuthTitle); G.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromHSV(0,1,1)), ColorSequenceKeypoint.new(0.5, Color3.fromHSV(0.5,1,1)), ColorSequenceKeypoint.new(1, Color3.fromHSV(1,1,1))}
task.spawn(function() while AuthTitle.Parent do G.Offset = Vector2.new(math.sin(tick() * 1.2) * 0.4, 0); task.wait() end end)
